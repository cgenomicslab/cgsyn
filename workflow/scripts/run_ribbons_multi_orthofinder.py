...
print(f"\n{'='*60}")
print(f"MULTI-SPECIES RIBBON PLOT{'  (shared OG mode)' if snakemake.params.shared_ogs else ''}")
print(f"{'='*60}")
...
if snakemake.params.alg_discovery:
    ...
    heatmap_path = os.path.join(
        os.path.dirname(snakemake.params.alg_results_path),
    ...
    print(f"\nSkipping ALG discovery (use --alg-discovery-orthofinder flag to enable)")
